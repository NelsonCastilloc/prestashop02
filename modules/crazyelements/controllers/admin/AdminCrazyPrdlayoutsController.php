...
class AdminCrazyPrdlayoutsController extends ModuleAdminController {
    ...
    public function renderList() {
        ...
        <a  href="https://classydevs.com/prestashop-page-builder/pricing/?utm_source=crazyfree_prdlayouts&utm_medium=crazyfree_prdlayouts_module&utm_campaign=crazyfree_prdlayouts&utm_term=crazyfree_prdlayouts&utm_content=crazyfree_prdlayouts?utm_source=crazyfree_prdlayouts&utm_medium=crazyfree_prdlayouts_module&utm_campaign=crazyfree_prdlayouts&utm_term=crazyfree_prdlayouts&utm_content=crazyfree" target="_blank"> <img src=" ' . CRAZY_ASSETS_URL . 'images/price_compare.jpg" width="1200"></a></div></div>';
        return $html;
	}
}